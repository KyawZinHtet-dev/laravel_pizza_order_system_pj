            ...
            <div class="col-lg-12 col-md-12">
                <div class="row pb-3">
                    <div class="col-2 offset-10 mb-3">
                        <select name="sortOption" id="sortOption" class=" form-control form-control-sm w-75 bg-dark text-white rounded-bottom">
                            <option value='0' selected>Filter With Price...(All)</option>
                            <option value="10000" >1000ks</option>
                            <option value="20000" >2000ks</option>
                            <option value="30000" >3000ks</option>
                            <option value="40000" >4000ks</option>
                        </select>
                    </div>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="{{ route('user#showProductDetailPage',$product->product_id) }}"><i class="fas fa-info-circle"></i></a>
                                </div>
                            </div>

            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0" id="cartTable">
                    ...
                    <tbody class="align-middle">
                       ...
                       <tr>
                        <td class="align-middle"><img src="{{ asset('storage/product_images/'.$cartData->image) }}" alt="" style="width: 80px;"></td>
                        ...
                        <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                ...
                                <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="{{ $cartData->qty }}" id="qty">
                                <div class="input-group-btn">
                        ...
                        <td class="align-middle col-2" id="totalPrice" >{{ $cartData->product_price * $cartData->qty }}ks</td>
                        <td class="align-middle"><button class="btn btn-danger removeBtn"><i class="fa fa-times"></i></button></td>
                    </tr>
                       @endforeach
                    </tbody>
                </table>
        ...
        $('document').ready(function(){
            ...
            $('.removeBtn').click(function(){
                ...
                $.ajax({
                        ...
                        data : {productId : product_id,cartId : cart_id},
                        dataType : 'json',
            ...
            $('#orderBtn').click(function(){
                ...
                $('#cartTable tbody tr').each(function(index,row){
                    orderList[index] = {
                        ...
                        order_code : 'PZS' + parseInt($(row).find('#user_id').val()) + date + randomCode,
                    };
                })
